#tính chỉ số BMI và in ra kèm kết quả đánh giá
...
def B1_click():
	...
	x2= float(E2.get())
	BMI= x2/(x1*x1)
	KQ.configure(text ="BMI =" + str(round(BMI,2)))
	if BMI < 18.5:
...
L1 = Label(master = W, text = "Tính chỉ số BMI", font = ("arial",20),bg = "blue",fg ="white") #italic: in nghiêng
